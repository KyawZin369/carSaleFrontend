...
const Profile = () => {
  ...
  const fetchUserDetails = async (): Promise<User> => {
    ...
    const { data: usersProfile, isLoading, isError, error } = useQuery<User>({
      queryKey: ["user"],
  ...
  return (
    ...
    >
      <div className="max-w-3xl w-full bg-white/80 backdrop-blur-md p-6 shadow-xl rounded-lg">
        ...
        <h2 className="text-3xl font-bold text-blue-700 mb-6 text-center">Profile Details</h2>
        ...
        {!isEditing ? (
          <div className="p-6">
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-700">{usersProfile?.profile_details ? usersProfile?.profile_details : "User Details...."}</p>
            </div>
            <button
          ...
          <div className="p-6">
            ...
            <div className="mb-4">
              <label className="block text-sm font-semibold text-blue-600 mb-2">Name</label>
              <input
                type="text"
                name="name"
            ...
            <div className="mb-4">
              <label className="block text-sm font-semibold text-blue-600 mb-2">Email</label>
              <input
                type="email"
                name="email"
            ...
            <div className="mb-4">
              <label className="block text-sm font-semibold text-blue-600 mb-2">Profile Details</label>
              <input
                type="text"
                name="profile_details"
                value={editedProfile.profile_details ?? 'User Profile Details...'}
                onChange={handleChange}
                className="w-full p-3 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-300"
              />
            </div>
